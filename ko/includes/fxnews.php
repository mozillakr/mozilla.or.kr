    <form class="billboard"
      ...
      <div class="form-contents">
        <div class="field field-email ">
          <input type="email" required="true" placeholder="이메일 주소를 입력하세요" name="email" id="id_email" />
        </div>
...
<option value="ru">Русский</option>
            ...
            <label for="id_fmt_0"><input checked="checked" type="radio" id="id_fmt_0" value="H" name="fmt" /> HTML</label><label for="id_fmt_1"><input type="radio" id="id_fmt_1" value="T" name="fmt" /> Text</label>
          </div>
          <div class="field field-privacy ">
            <label for="id_privacy" class="privacy-check-label"><input required="true" type="checkbox" name="privacy" id="id_privacy" /> <span class="title"><a href="http://www.mozilla.org/en-US/privacy-policy">개인 정보 보호 정책</a>을 읽었으며 이에 동의합니다.</span></label>
          </div>
        </div>
      </div>
      ...
      <div class="form-submit">
        ...
        <p class="form-details">
          <small>Mozilla와 관련된 정보만 보내드립니다.</small>
        </p>
      </div>
    </form>
