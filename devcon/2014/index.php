...
<div id="nav">
	<div id="navitems">
		<ul>
			...
			<li><a href="#submit">발표신청</a></li>
			<li><a href="#registration">등록하기</a></li>
		</ul>
	</div>
</div>
		...
		<p class="location">서울 강남 코엑스 콘퍼런스 센터 317호</p>
 		...
 		<p class="logo">Sponsored by <img src="images/mozilla_logo.png" alt="Mozilla" align="absmiddle"> 
                ...
                <div align="center" style="padding:10px;">
                                ...
                                <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://www.mozilla.or.kr/devcon/2014" data-text="Firefox 개발자 콘퍼런스 2014- Firefox OS와 미래 웹 기술을 직접 만나보세요!" data-via="mozillakr" data-lang="ko" data-hashtags="fxdevconkr">트윗하기</a>
...
<div class="contentsection clearfix beige">
	<div class="content">
			<h2>프로그램</h2>
			<p>Mozilla 커뮤니티 및 웹 개발자를 위한 기술 동향, Firefox OS와 구현 사례 등에 대해 알차게 꾸몄습니다.</p>
		<!-- </div> -->
		<!-- <div class="normalcontent"> -->
			<div class="agenda">
				<div class="agendaitem">
					<div class="agendaday">
						<div class="session">
							<h3>인사말</h3>
							<p class="time">10:00 - 10:10</p>
							<p class="speaker">신현석(Mozilla 한국커뮤니티 대표, Daum)</p>
						</div>
						<div class="session">
...
<a id="registration"></a>
<div class="contentsection beige clearfix">
	<div class="content">
		<div class="sectioninfo relative">
			<h2>사전 등록하기</h2>
